...
public class EmployeeDto {
	...
	public static List<Employee> findEmployees() {
		Employee e1 = new Employee(1, "Adam", 48, "Finance", 10000, true);
		...
		Employee e5 = new Employee(5, "Eliza", 13, "Human Resource", 14000, true);
		Employee e6 = new Employee(6, "Ferry", 15, "Information Technology", 15000, false);
		Employee e7 = new Employee(7, "Gagan", 16, "Information Technology", 16000, true);
		Employee e8 = new Employee(8, "Herry", 20, "Information Technology", 17000, false);
		Employee e9 = new Employee(9, "Ilyas", 17, "Science", 20000, true);
